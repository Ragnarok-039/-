Данный каталог содержит тестовое задание для компании "Контур".

Основная логика - main.ipynb
SQL запрос расположен в папке SQL.
Для работы выбрана БД sqlite.
Перед повторным выполнением кода необходимо разместить в папке db соответствующий бэкап БД - testDB.sqlite3.
Из-за личного ограничения по времени выполнена только первая часть задания.
